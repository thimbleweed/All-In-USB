...
<?php } ?>
<button class="tool_add" type="button" onclick="window.parent.frames['iso_content'].location = 'iso_config_add.php';">Add Boot Item</button>
<button class="tool_cnf" type="button" onclick="window.parent.frames['iso_content'].location = 'iso_config.php';">Configure Boot Item</button>
<button class="tool_del" type="button" onclick="window.parent.frames['iso_content'].location = 'iso_config_delete.php';">Remove Boot Item</button>
